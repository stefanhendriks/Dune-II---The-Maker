...
int main(int argc, char* argv[]) {
    ...
    const float quadWidthNdc = 2.0f * static_cast<float>(imageWidth) / static_cast<float>(windowWidth);
    const float quadHeightNdc = 2.0f * static_cast<float>(imageHeight) / static_cast<float>(windowHeight);

    Vertex quadVertices[12] = {
        // Quad 1: coin bas-gauche
        { -1.0f,               -1.0f,                0.0f, 1.0f },
        { -1.0f + quadWidthNdc, -1.0f,                1.0f, 1.0f },
        { -1.0f + quadWidthNdc, -1.0f + quadHeightNdc, 1.0f, 0.0f },
        { -1.0f,               -1.0f,                0.0f, 1.0f },
        { -1.0f + quadWidthNdc, -1.0f + quadHeightNdc, 1.0f, 0.0f },
        { -1.0f,               -1.0f + quadHeightNdc, 0.0f, 0.0f },

        // Quad 2: décalé vers le centre (chevauchement partiel)
        { -1.0f + (quadWidthNdc * 0.5f),  -1.0f + (quadHeightNdc * 0.5f),  0.0f, 1.0f },
        { -1.0f + (quadWidthNdc * 1.5f),  -1.0f + (quadHeightNdc * 0.5f),  1.0f, 1.0f },
        { -1.0f + (quadWidthNdc * 1.5f),  -1.0f + (quadHeightNdc * 1.5f),  1.0f, 0.0f },
        { -1.0f + (quadWidthNdc * 0.5f),  -1.0f + (quadHeightNdc * 0.5f),  0.0f, 1.0f },
        { -1.0f + (quadWidthNdc * 1.5f),  -1.0f + (quadHeightNdc * 1.5f),  1.0f, 0.0f },
        { -1.0f + (quadWidthNdc * 0.5f),  -1.0f + (quadHeightNdc * 1.5f),  0.0f, 0.0f }
    };
