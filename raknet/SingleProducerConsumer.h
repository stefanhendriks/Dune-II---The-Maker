...
namespace BasicDataStructures
{
	...
	public:
		...
		void AssertReadUnlockOrder(const SingleProducerConsumerType* data) const;
	...
	template <class SingleProducerConsumerType>
	void SingleProducerConsumer<SingleProducerConsumerType>::AssertReadUnlockOrder(const SingleProducerConsumerType* data) const
	{
#ifdef _DEBUG
...
/// Test code for the SingleProducerConsumer class
/*
...
BasicDataStructures::SingleProducerConsumer<unsigned long> spc;
...
void main(void)
{
	...
	//	SetThreadPriority(thread1Handle,THREAD_PRIORITY_BELOW_NORMAL);
	//	SetThreadPriority(thread2Handle,THREAD_PRIORITY_ABOVE_NORMAL);
