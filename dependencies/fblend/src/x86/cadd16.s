...
FUNC(fblend_add_sse_16)
	...
	je draw_color_add_sse_16_full
	

	BLIT_LOOP(draw_color_add_sse_16, 2, 2,
	...
	color_add_sse_16_loop:
		...
		movq (msb_mask16), %mm6;
		ADD_SATURATE_16_4_MMX(%mm0, %mm2, %mm6, %mm5, %mm4);
		ADD_SATURATE_16_4_MMX(%mm1, %mm3, %mm6, %mm5, %mm4);
		movq (rb_mask16), %mm6;
	...
	color_add_sse_16_rest_of_line:
		...
		movq (msb_mask16), %mm5;
		movq (rb_mask16), %mm4;
		jnc color_add_sse_16_two_pixels;
	
	color_add_sse_16_one_pixel:

		movzwl (%esi), %edx;       /*src |......| rgb1 | */
		movd %edx, %mm0;
	...
	color_add_sse_16_two_pixels:
		shrl $1, %ecx;
		jnc color_add_sse_16_four_pixels;
	...
	color_add_sse_16_four_pixels:
		shrl $1, %ecx;
		jnc color_add_sse_16_end_blend;
	 ...
	 */
	draw_color_add_sse_16_full:

    movq (msb_mask16), %mm6;
    movq (rb_mask16), %mm7;
	
	BLIT_LOOP(draw_color_add_sse_16_full, 2, 2,
	
		shrl $3, %ecx;
		jz color_add_sse_16_full_rest_of_line;

	_align_;
	color_add_sse_16_full_loop:
		...
		ZERO_ON_EQUAL_16_8_MMX(%mm0, %mm1, %mm7, %mm2, %mm3);
		...
		jnz color_add_sse_16_full_loop;

	color_add_sse_16_full_rest_of_line:		
		movl B_WIDTH, %ecx;     /* Check if there are pixels left */
		andl $7, %ecx;
		jz color_add_sse_16_full_end;

		shrl $1, %ecx;
		jnc color_add_sse_16_full_two_pixels;

	color_add_sse_16_full_one_pixel:
		movzwl (%esi), %eax;       /*src |......| rgb1 | */
		movd %eax, %mm0;

		ZERO_ON_EQUAL_16_4_MMX(%mm0, %mm7, %mm2);
	...
	color_add_sse_16_full_two_pixels:
		shrl $1, %ecx;
		jnc color_add_sse_16_full_four_pixels;
	...
	_align_;
	color_add_sse_16_full_four_pixels:
		shrl $1, %ecx;
		jnc color_add_sse_16_full_end;
		...
		_align_;
		color_add_sse_16_full_end:
	)

	draw_color_add_sse_16_end:
...
FUNC(fblend_add_mmx_16)
	...
	cmpl $32, %ecx                /* Special case: factor == 32 */
	je draw_color_add_mmx_16_full
	

	BLIT_LOOP(draw_color_add_mmx_16, 2, 2,
	
		shrl $3, %ecx;
		jz color_add_mmx_16_rest_of_line;

	_align_;
	color_add_mmx_16_loop:
		...
		jnz color_add_mmx_16_loop;

	color_add_mmx_16_rest_of_line:		
		movl B_WIDTH, %ecx;     /* Check if there are pixels left */
		andl $7, %ecx;
		jz color_add_mmx_16_end;

		shrl $1, %ecx;
		movq (msb_mask16), %mm5;
		movq (rb_mask16), %mm4;
		jnc color_add_mmx_16_two_pixels;
	
	color_add_mmx_16_one_pixel:
	...
	color_add_mmx_16_two_pixels:
		shrl $1, %ecx;
		jnc color_add_mmx_16_four_pixels;
	...
	_align_;
	color_add_mmx_16_four_pixels:
		shrl $1, %ecx;
		jnc color_add_mmx_16_end;
		...
		_align_;
		color_add_mmx_16_end:
	)
	
	jmp draw_color_add_mmx_16_end
	
	
	/***********************
	 * Start of special case
	 */
	draw_color_add_mmx_16_full:

    movq (msb_mask16), %mm7;
	
	BLIT_LOOP(draw_color_add_mmx_16_full, 2, 2,
	
		shrl $3, %ecx;
		jz color_add_mmx_16_full_rest_of_line;

	_align_;
	color_add_mmx_16_full_loop:
		...
		ADD_SATURATE_16_8_MMX(%mm0, %mm1, %mm2, %mm3, %mm7, %mm5, %mm4, %mm6);

		movq %mm2, %es:-16(%edi);  /* Write the results */
		movq %mm3, %es:-8(%edi);
		decl %ecx;

		jnz color_add_mmx_16_full_loop;

	color_add_mmx_16_full_rest_of_line:		
		movl B_WIDTH, %ecx;     /* Check if there are pixels left */
		andl $7, %ecx;
		jz color_add_mmx_16_full_end;

		shrl $1, %ecx;
		movq (rb_mask16), %mm4;
		jnc color_add_mmx_16_full_two_pixels;

	color_add_mmx_16_full_one_pixel:
		movzwl (%esi), %eax;       /*src |......| rgb1 | */
		movd %eax, %mm0;
		...
		ADD_SATURATE_16_4_MMX(%mm0, %mm1, %mm7, %mm2, %mm3);
	...
	color_add_mmx_16_full_two_pixels:
		shrl $1, %ecx;
		jnc color_add_mmx_16_full_four_pixels;
	...
	_align_;
	color_add_mmx_16_full_four_pixels:
		shrl $1, %ecx;
		jnc color_add_mmx_16_full_end;
		...
		_align_;
		color_add_mmx_16_full_end:
	)

	draw_color_add_mmx_16_end:
