...
#define DEFENCODING(xxx_names,xxx,xxx_ifuncs1,xxx_ifuncs2,xxx_ofuncs1,xxx_ofuncs2) \
  ei_##xxx ,
#include "encodings/encodings.def"
#ifdef USE_AIX
#include "encodings/aix.def"
#endif
#ifdef USE_OSF1
#include "encodings/osf1.def"
#endif
#ifdef USE_DOS
#include "encodings/dos.def"
#endif
#include "encodings/local.def"
#undef DEFENCODING
...
#ifdef USE_AIX
#include "aliases/aix.h"
#endif
#ifdef USE_OSF1
#include "aliases/osf1.h"
#endif
#ifdef USE_DOS
#include "aliases/dos.h"
#endif
};
#ifdef __GNUC__
__inline
