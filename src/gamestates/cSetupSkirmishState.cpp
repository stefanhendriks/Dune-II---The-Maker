...
#include "gameobjects/players/brains/cPlayerBrainSandworm.h"
...
cSetupSkirmishState::cSetupSkirmishState(sGameServices* services, cPreviewMaps* previewMaps,s_DataCampaign* dataCompaign) :
    cGameState(services),
