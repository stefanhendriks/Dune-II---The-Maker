...
public:
    ...
    bool isDead() {
        return dead;    // if set, then it is eligible for cleanup
    }
    ...
    int getOwner() {
        return iPlayer;    // return the player id who owns this structure
    }
    int getRallyPoint() {
        return iRallyPoint;
    }
    ...
    bool hasUnitWithin() const {
        return iUnitIDWithinStructure > -1;
    }
    int getUnitIdWithin() const {
        return iUnitIDWithinStructure;
    }
    void setUnitIdWithin(int unitId);

    bool hasUnitHeadingTowards() const {
        return iUnitIDHeadingForStructure > -1;
    }
    int getUnitIdHeadingTowards() const {
        return iUnitIDHeadingForStructure;
    }
    void setUnitIdHeadingTowards(int unitId);

    bool hasUnitEntering() const {
        return iUnitIDEnteringStructure > -1;
    }
    int getUnitIdEntering() const {
        return iUnitIDEnteringStructure;
    }
    void setUnitIdEntering(int unitId);

    bool isValid();
    bool canAttackAirUnits() const {
        return getStructureInfo().canAttackAirUnits;
    }
    bool canAttackGroundUnits() const {
