...
private:
    ...
    static const char *ePlayerBrainSkirmishEconomyStateString(const ePlayerBrainSkirmishEconomyState &state) {
        switch (state) {
            case ePlayerBrainSkirmishEconomyState::PLAYERBRAIN_ECONOMY_STATE_NORMAL:
                return "PLAYERBRAIN_ECONOMY_STATE_NORMAL";
            case ePlayerBrainSkirmishEconomyState::PLAYERBRAIN_ECONOMY_STATE_IMPROVE:
                return "PLAYERBRAIN_ECONOMY_STATE_IMPROVE";
            case ePlayerBrainSkirmishEconomyState::PLAYERBRAIN_ECONOMY_STATE_GOOD:
                return "PLAYERBRAIN_ECONOMY_STATE_GOOD";
            case ePlayerBrainSkirmishEconomyState::PLAYERBRAIN_ECONOMY_STATE_BAD:
    ...
    static const char *ePlayerBrainStateString(const ePlayerBrainState &state) {
        switch (state) {
            case ePlayerBrainState::PLAYERBRAIN_ENEMY_DETECTED:
                return "PLAYERBRAIN_ENEMY_DETECTED";
            case ePlayerBrainState::PLAYERBRAIN_LOSING:
                return "PLAYERBRAIN_LOSING";
            case ePlayerBrainState::PLAYERBRAIN_PEACEFUL:
                return "PLAYERBRAIN_PEACEFUL";
