...
void cKeyBindings::loadDefaults()
{
    ...
    bind(eKeyAction::SELECT_WHEELS_ON_MAP,      {SDL_SCANCODE_W}, true, false, false);
    ...
    bind(eKeyAction::SELECT_ATTACKING_ON_MAP,    {SDL_SCANCODE_A}, true, false, false);
    ...
    bind(eKeyAction::GROUP_ASSIGN_1, {SDL_SCANCODE_1}, true, false, false);
    bind(eKeyAction::GROUP_ASSIGN_2, {SDL_SCANCODE_2}, true, false, false);
    bind(eKeyAction::GROUP_ASSIGN_3, {SDL_SCANCODE_3}, true, false, false);
    ...
    bind(eKeyAction::EDITOR_CUT,      {SDL_SCANCODE_X}, true, false, false);
...
const std::vector<std::pair<std::string, eKeyAction>>& cKeyBindings::getActionTable()
{
    static const std::vector<std::pair<std::string, eKeyAction>> TABLE = {
        ...
        {"SELECT_WHEELS_ON_MAP",      eKeyAction::SELECT_WHEELS_ON_MAP},
        ...
        {"SELECT_ATTACKING_ON_MAP",   eKeyAction::SELECT_ATTACKING_ON_MAP},
        ...
        {"EDITOR_CUT",                eKeyAction::EDITOR_CUT},
