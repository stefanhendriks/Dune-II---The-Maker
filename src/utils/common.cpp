...
int createBullet(int type, int fromCell, int targetCell, int unitWhichShoots, int structureWhichShoots)
{
    ...
    if (structureIdAtTargetCell > -1) {
        cAbstractStructure *pStructure = g_pStructure[structureIdAtTargetCell];
    ...
    if (unitWhichShoots > -1 ) {
        cUnit &cUnit = g_Units[unitWhichShoots];
    ...
    if (structureWhichShoots > -1) {
        cAbstractStructure *pStructure = g_pStructure[structureWhichShoots];
        ...
        if (unitIdAtTargetCell > -1) {
            cUnit &unitTarget = g_Units[unitIdAtTargetCell];
