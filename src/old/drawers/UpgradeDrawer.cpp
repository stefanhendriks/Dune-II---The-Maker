...
UpgradeDrawer::UpgradeDrawer() {
	GuiShapeFactory * factory = new GuiShapeFactory(/*game.getScreenResolution()*/NULL);
...
bool UpgradeDrawer::shouldDrawButtonForSelectedList(cPlayer * thePlayer, cBuildingList * theSelectedList) {
	assert(thePlayer);
...
void UpgradeDrawer::drawUpgradeButtonForSelectedListIfNeeded(cPlayer * thePlayer, cBuildingList * theSelectedList) {
	assert(thePlayer);
...
void UpgradeDrawer::drawUpgradeButton(cPlayer * thePlayer, cBuildingList * theSelectedList) {
	assert(thePlayer);
	assert(theSelectedList);
	int techLevel = thePlayer->getTechLevel();
	int upgradeLevel = theSelectedList->getUpgradeLevel();
...
void UpgradeDrawer::drawUpgradeProgress(cPlayer * thePlayer, cBuildingList * theSelectedList) {
	assert(thePlayer);
	assert(theSelectedList);
