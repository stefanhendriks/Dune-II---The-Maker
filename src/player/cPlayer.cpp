...
void cPlayer::update()
{
    powerUsage_ = game.g_structureUtils.getTotalPowerUsageForPlayer(this);
    powerProduce_ = game.g_structureUtils.getTotalPowerOutForPlayer(this);
    // update spice capacity
    maxCredits_ = game.g_structureUtils.getTotalSpiceCapacityForPlayer(this);
}
...
eCantBuildReason cPlayer::canBuildUnit(int iUnitType, bool checkIfAffordable)
{
    ...
    int iStrucType = game.g_structureUtils.getStructureTypeByUnitBuildId(iUnitType);
