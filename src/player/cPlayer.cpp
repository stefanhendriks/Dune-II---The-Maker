...
void cPlayer::update()
{
    powerUsage_ = g_structureUtils.getTotalPowerUsageForPlayer(this);
    powerProduce_ = g_structureUtils.getTotalPowerOutForPlayer(this);
    // update spice capacity
    maxCredits_ = g_structureUtils.getTotalSpiceCapacityForPlayer(this);
}
...
eCantBuildReason cPlayer::canBuildUnit(int iUnitType, bool checkIfAffordable)
{
    ...
    int iStrucType = g_structureUtils.getStructureTypeByUnitBuildId(iUnitType);
