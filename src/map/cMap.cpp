...
void cMap::thinkAboutRespawningWorms()
{
    ...
    int currentAmountOfWorms = game.getPlayers()[AI_WORM].getAmountOfUnitsForType(SANDWORM);
            ...
            if (!isVisible(cl, playerId)) {
                ...
                if (structureId > -1) {
                    ...
                    s_GameEvent event{
                        ...
                        .player = &game.getPlayers()[playerId],
...
{
    if (game.getPlayers()[HUMAN].getGameControlsContext()->getMouseCell() > -1) {
        int mouseCell = game.getPlayers()[HUMAN].getGameControlsContext()->getMouseCell();
