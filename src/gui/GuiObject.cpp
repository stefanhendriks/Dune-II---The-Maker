...
void GuiObject::drawRectBorder(Color borderRect, Color borderBottomRight) const
{
    ...
    renderDrawer->renderLine(x1+width-1, y1, x1+width-1, y1+height-1,borderBottomRight);
    renderDrawer->renderLine(x1, y1+height-1, x1+width-1, y1+height-1, borderBottomRight);
}
